...
class Decrement(Command):
    name = "decr"
    regex_cmd = re.compile(br"^decr (?P<key>\w+) (?P<value>\d+)( (?P<noreply>noreply))?$")
...
class Delete(Command):
    name = "delete"
    regex_cmd = re.compile(br"^(?P<command>\w+) (?P<key>\w+)( (?P<noreply>noreply))?$")
...
class Increment(Command):
    name = "incr"
    regex_cmd = re.compile(br"^incr (?P<key>\w+) (?P<value>\d+)( (?P<noreply>noreply))?$")
...
class StorageCommand(Command):
    regex_cmd = re.compile(br"^(?P<command>\w+) (?P<key>\w+) (?P<flags>\d+) (?P<exptime>\d+) (?P<byte_count>\d+)( (?P<noreply>noreply))?")
...
class Touch(Command):
    name = "touch"
    regex_cmd = re.compile(br"^touch (?P<key>\w+) (?P<exptime>\d+)( (?P<noreply>noreply))?$")
